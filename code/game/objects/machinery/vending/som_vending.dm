/obj/machinery/vending/weapon/som
	...
	products = list(
		...
		"Energy Weapons" = list(
			...
			/obj/item/weapon/gun/energy/lasgun/lasrifle/volkite/caliver = 4,
			/obj/item/weapon/gun/energy/lasgun/lasrifle/volkite/serpenta = 4,
		...
		"Grenades" = list(
			...
			/obj/item/explosive/grenade/smokebomb/sleep = 3,
